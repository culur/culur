...
export const renovateSharedConfig = {
  ...
  automerge: [
    ...
    'automergeType', // 'pr' | 'branch-push' | 'pr-comment': Specifies the automerge mechanism. Deprecated/renamed? (Note: Not in original list, added for context, potentially maps to other settings).
    ...
    'platformAutomerge', // boolean: Use the platform's native automerge feature if available. (Note: Not in original list, but common).
  ],
