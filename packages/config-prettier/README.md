...
```bash
prettier ** --write --ignore-path node_modules/@culur/config-prettier/.prettierignore
```
...
It will copy the `.prettierignore` from `@culur/config-prettier` to your project root folder.
