  ...
  implements BaseRunnable
{
  ...
  log(props: Arrayable<LineColProps['text'] | LineColProps>, icon = Icon.Info) {
    ...
    this.pushTasks(new Log(this, props, icon));
    this.onChange();
    return this;
  }
  ...
  async logData<TCData>(data: TCData, icon = Icon.Info) {
    ...
    this.pushTasks(new Log(this, <BoxSyntaxJS code={code} />, icon));
    this.onChange();
    return this;
  }
